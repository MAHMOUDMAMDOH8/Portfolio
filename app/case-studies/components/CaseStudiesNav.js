      ...
      <nav className="sticky top-0 z-40 border-b border-zinc-200/80 bg-white/85 backdrop-blur-xl dark:border-white/[0.06] dark:bg-[#050508]/90">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between gap-3 px-4 sm:h-16 sm:px-6 lg:px-8">
          <button
            type="button"
            onClick={onBack}
            className="inline-flex items-center gap-2 rounded-lg border border-zinc-200 px-3 py-2 text-sm text-zinc-700 transition hover:border-cyan-500/40 hover:text-zinc-900 dark:border-white/10 dark:text-zinc-300 dark:hover:text-white"
          >
            <FaArrowLeft />
  ...
  return (
    <nav className="sticky top-0 z-40 border-b border-zinc-200/80 bg-white/85 backdrop-blur-xl dark:border-white/[0.06] dark:bg-[#050508]/90">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between gap-3 px-4 sm:h-16 sm:px-6 lg:px-8">
        ...
        <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-cyan-700 dark:text-cyan-400/90">Case studies</p>
        <div className="flex items-center gap-2">
          <Link
            href="/"
            className="hidden text-sm font-medium text-zinc-600 transition hover:text-cyan-700 sm:inline dark:text-zinc-400 dark:hover:text-cyan-300"
          >
            Home
          </Link>
          <ThemeToggleButton />
