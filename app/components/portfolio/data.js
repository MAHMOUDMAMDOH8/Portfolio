/* ───────────────────────────────────────────────
   ...
   All copy preserved — reorganized for clarity
   ─────────────────────────────────────────────── */
...
// ─── Platform flow (sticky story) ───────────────
export const platformFlow = [
  {
    id: 'ingest',
    step: '01',
    layer: 'bronze',
    title: 'Ingest & stream events',
    subtitle: 'Real-time capture at the edge',
    description:
      'High-throughput ingestion from Kafka, NiFi, and Airbyte with schema validation, dead-letter routing, and CDC into landing zones — built for telecom, ecommerce, and ops telemetry.',
    stack: ['Kafka', 'NiFi', 'Airbyte', 'CDC'],
    flow: 'Sources → topics → raw landing',
  },
  {
    id: 'process',
    step: '02',
    ...
    subtitle: 'Spark on lakehouse storage',
    description:
      'Bronze-to-silver transforms with PySpark on Iceberg or HDFS — deduplication, enrichment, quality gates, and medallion contracts that scale with data volume.',
    stack: ['Spark', 'Iceberg', 'MinIO', 'Hadoop'],
    flow: 'Bronze → validation → silver tables',
  },
  {
    id: 'model',
    step: '03',
    layer: 'gold',
    title: 'Model & orchestrate',
    subtitle: 'dbt marts + Airflow DAGs',
    description:
      'Dimensional models, incremental marts, and orchestrated pipelines with freshness SLAs, lineage, and automated tests — galaxy schemas ready for analytics.',
    stack: ['dbt', 'Airflow', 'SQL', 'Iceberg'],
    flow: 'Silver → dbt → gold marts',
  },
  {
    id: 'activate',
    step: '04',
    ...
    subtitle: 'Warehouse + BI + observability',
    description:
      'Curated datasets in Snowflake or ClickHouse, executive Power BI layers, and Streamlit ops dashboards — so stakeholders adopt metrics they trust.',
    stack: ['Snowflake', 'ClickHouse', 'Power BI', 'Streamlit'],
    flow: 'Gold → warehouse → dashboards',
  },
]
...
export const recruiterFocusTags = [
  ...
  'Docker', 'Hadoop & Hive', 'Airbyte', 'ETL / ELT pipelines',
  'Real-time streaming', 'Cloud & analytics engineering',
]
...
export const marqueeTools = [
  'Medallion Architecture', 'Apache Spark', 'Iceberg Lakehouse',
  'Hadoop & Hive', 'Airflow DAGs', 'Airbyte', 'dbt Marts',
  'Change Data Capture', 'Streamlit Observability', 'Power BI Storytelling',
...
export const learningFocus = [
  {
    label: 'Exploring now',
    items: [
      'Streaming change tracking with Iceberg',
      'Open metadata & data contracts',
      'Data observability design systems',
    ],
  },
  {
    label: 'Sharing back',
    items: [
      'Authoring case studies & blog drafts',
      'Mentoring peers on CDC & lakehouse patterns',
...
/** Maps project.category to filter id for the projects grid. */
export function projectFilterId(category = '') {
  const c = category.toLowerCase()
  if (c.includes('lakehouse')) return 'lakehouse'
  if (c.includes('stream') || c.includes('realtime') || c.includes('real-time')) return 'streaming'
  if (c.includes('warehouse') || c.includes('olap') || c.includes('dimensional') || c.includes('analytics engineering'))
    return 'warehouse'
  if (c.includes('platform') || c.includes('data engineering') || c.includes('enterprise')) return 'platform'
  return 'platform'
}

export const toolNodes = [
  { label: 'Apache Spark', category: 'Platform', style: { top: 'calc(50% - 140px)', left: 'calc(50% + 130px)' } },
  { label: 'Apache Iceberg', category: 'Platform', style: { top: 'calc(50% - 60px)', left: 'calc(50% + 190px)' } },
  { label: 'MinIO / S3', category: 'Platform', style: { top: 'calc(50% + 10px)', left: 'calc(50% + 155px)' } },
  { label: 'Snowflake', category: 'Platform', style: { top: 'calc(50% + 120px)', left: 'calc(50% + 95px)' } },
  { label: 'PostgreSQL', category: 'Platform', style: { top: 'calc(50% + 160px)', left: 'calc(50% - 30px)' } },
  { label: 'Apache Airflow', category: 'Orchestration', style: { top: 'calc(50% + 120px)', left: 'calc(50% - 130px)' } },
  { label: 'dbt', category: 'Orchestration', style: { top: 'calc(50% + 40px)', left: 'calc(50% - 185px)' } },
  { label: 'Medallion Design', category: 'Orchestration', style: { top: 'calc(50% - 20px)', left: 'calc(50% - 210px)' } },
  { label: 'Dimensional Modelling', category: 'Orchestration', style: { top: 'calc(50% - 110px)', left: 'calc(50% - 170px)' } },
  { label: 'Streamlit', category: 'Activation', style: { top: 'calc(50% + 20px)', left: 'calc(50% + 75px)' } },
  { label: 'Power BI', category: 'Activation', style: { top: 'calc(50% - 60px)', left: 'calc(50% + 40px)' } },
  { label: 'Executive Storytelling', category: 'Activation', style: { top: 'calc(50% - 150px)', left: 'calc(50% - 10px)' } },
  { label: 'Docker', category: 'Automation', style: { top: 'calc(50% - 165px)', left: 'calc(50% - 80px)' } },
  { label: 'CI/CD Pipelines', category: 'Automation', style: { top: 'calc(50% - 60px)', left: 'calc(50% - 100px)' } },
  { label: 'Data Quality Automation', category: 'Automation', style: { top: 'calc(50% + 40px)', left: 'calc(50% - 60px)' } },
]
...
export const projects = [
  ...
  },
  {
    ...
    links: [
      { label: 'View GitHub', href: 'https://github.com/MAHMOUDMAMDOH8/Multisystem-ETL-Lakehouse_for-Business-Insights', external: true },
  ...
  },
  {
    ...
    links: [
      { label: 'View GitHub', href: 'https://github.com/MAHMOUDMAMDOH8/end-to-end-log-processing', external: true },
      { label: 'See live demo', href: 'https://mahmoud-ecommerce-dashboard.streamlit.app', external: true },
    ],
    architectureImage: '/project_image/End-to-End%20Big%20Data%20Pipeline%20for%20E-commerce%20Event%20Logs.jpeg',
  },
  {
    ...
    links: [
      { label: 'View GitHub', href: 'https://github.com/MAHMOUDMAMDOH8/telecom-streaming-pipeline', external: true },
    ],
  ...
  },
  {
    ...
    links: [
      { label: 'View GitHub', href: 'https://github.com/MAHMOUDMAMDOH8/elt-engine', external: true },
    ],
  ...
  },
  {
    ...
    links: [
      { label: 'View GitHub', href: 'https://github.com/MAHMOUDMAMDOH8/OLAPify', external: true },
    ],
  ...
  },
  {
    ...
    links: [
      { label: 'View GitHub', href: 'https://github.com/MAHMOUDMAMDOH8/DBT-Orchestrator', external: true },
    ],
  ...
  },
  {
    ...
    links: [
      { label: 'View GitHub', href: 'https://github.com/MAHMOUDMAMDOH8/OLAP_Dimensional_Modeling_for_Advanced_Analytics', external: true },
    ],
  ...
  },
  {
    ...
    links: [
      { label: 'View GitHub', href: 'https://github.com/MAHMOUDMAMDOH8/E2E-e-commerce-data-pipeline', external: true },
    ],
  ...
  },
  {
    ...
    links: [
      { label: 'View GitHub', href: 'https://github.com/MAHMOUDMAMDOH8/E-commerce-DWH', external: true },
    ],
...
export const certifications = [
  { name: 'Data Engineering Zoomcamp', provider: 'DataTalksClub · Jan–May 2025', image: '/Certifications/dezoomcamp.png' },
  { name: 'Data Engineering Foundations Specialization', provider: 'IBM · Nov 2023', image: '/Certifications/Data Engineering ibm.png' },
  { name: 'Data Engineer Career Track', provider: 'DataCamp · Oct 2023', image: '/Certifications/data enginer using python data camp.png' },
  { name: 'Google Business Intelligence Professional Certificate', provider: 'Coursera · May 2023', image: '/Certifications/Google Business Intelligence.jpeg' },
  { name: 'Associate Data Analyst in SQL', provider: 'DataCamp', image: '/Certifications/Associate Data Analyst in SQL datacamp.png' },
  { name: 'SQL for Business Analysts', provider: 'DataCamp', image: '/Certifications/SQL for Business Analysts datacamp.png' },
  { name: 'SQL Fundamentals', provider: 'DataCamp', image: '/Certifications/SQL Fundamentals datacamp.png' },
  { name: 'Data Analysis Challenger', provider: 'Udacity', image: '/Certifications/data analysis challenger udacity.png' },
  { name: 'Power BI Fundamentals', provider: 'DataCamp', image: '/Certifications/Power BI Fundamentals datacamp.png' },
  { name: 'Excel Fundamentals', provider: 'DataCamp', image: '/Certifications/Excel Fundamentals datacamp.png' },
  { name: 'Business Intelligence Track – Summer Training', provider: 'ITI · Menofia · Jul–Aug 2023', image: '/Certifications/iti.jpeg' },
]
